...
O objetivo desta análise foi verificar o comportamento das exportações de uva do Brasil em fevereiro de 2022. Os dados utilizados são mensais e disponibilizados pelo **Comexstat (MDIC)** para o período de *Janeiro de 2016 a Fevereiro de 2022*;
...
# 4. Principais destinos de exportação da uva do Brasil: `r strftime(atual, format = "%B")` de 2022. {.tabset .tabset-fade}
...
# 5. Principais vias de exportação da uva do Brasil: `r strftime(atual, format = "%B")` de 2022. {.tabset .tabset-fade}
...
# 6. Unidade da Federação da uva exportada do Brasil: `r strftime(atual, format = "%B")` de 2022. {.tabset .tabset-fade}
