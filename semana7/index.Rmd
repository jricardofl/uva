...
Os dados utilizados nesta análise são semanais e disponibilizados pelo **CEPEA (Esalq-USP)** englobando o período de 2017 a 2022, para uva sem semente branca e negra embaladas (incluso uva+material de embalagem+resfriamento, FOB-Petrolina), para os produtores do Vale do São Francisco. Também mostra informações sobre a uva negra sem embalagem, com dados semanais de 2019 à 2021. Os preços até a semana `r strftime(today, format = "%V de %Y")`, deflacionados pelo IGP-DI, são comparados com a média de cada semana entre 2017 e 2019 (pré pandemia), mínimo e máximo. Os preços deflacionados de 2020 e de 2021 também são apresentados para comparação de 2022 com os dois anos anteriores.

O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$14,01, variando entre R\$14,80 e R\$13,50. A média nesta semana é menor que a média histórica semanal deflacionada (R\$13,69), mas superou o valor deflacionado de 2020 (R\$ 11,47) e o valor de 2021 (R\$ 12,39). Em relação a semana `r strftime(last, format = "%V")` houve uma aumento, de 9,80%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$11,21, variando entre R\$12,00 e R\$10,40. Em 2020, o preço deflacionado é de R\$ 10,50. Em 2021 o preço é de R\$ 11,13 e a média histórica deflacionada para esta semana é de R\$ 13,31. Em relação à semana `r strftime(last, format = "%V")`, os preços cairam um pouco (-1,67%). Assim, o ano de 2022 começa com melhores preços do que os dois anteriores.

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` aumentou fortemente em relação a semana anterior (15,24%), na média de R\$6,88, variando entre R\$7,00 e R\$6,50. Este valor é menor do que o de 2020 deflacionado (R\$6,94), menor do que a média histórica deflacionada da semana (R\$8,03), mas é maior do que o valor de 2021 (R\$6,01). 
