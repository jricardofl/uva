...
exporta_uva_volume_22 <- as.matrix(tail(exporta_uva_volume,1)) #ajustar mensalmente
...
O objetivo desta análise foi verificar o comportamento das exportações de uva do Brasil em janeiro de 2022. Os dados utilizados são mensais e disponibilizados pelo **Comexstat (MDIC)** para o período de *Janeiro de 2016 a Janeiro de 2022*;

Em relação aos volumes, em `r strftime(atual, format = "%B")` foram de 1,12 mil toneladas (t). A média histórica (até 2019, antes da pandemia) para este mês é de 1,07 mil t. Em `r strftime(atual, format = "%B")` de 2020 foram exportadas 842 t e, em `r strftime(atual, format = "%B")` de 2021, foram 950 t, ou seja, houve um aumento de 33,01% em relação a 2020 e de 18,30% na comparação com o mesmo período de 2021.

Em termos dos valores da exportações, em `r strftime(atual, format = "%B")` foram cerca de 2,396 milhões de dólares (US\$). A média histórica (até 2019, antes da pandemia) para este mês é de US\$ 2,398 milhões. Em `r strftime(atual, format = "%B")` de 2020 foram gerados US\$ 2,139 milhões em receitas e, em `r strftime(atual, format = "%B")` de 2021, um total de US\$ 2,339 milhões, ou seja, os valores são praticamente os mesmos da média e das exportações de anos anteriores.
...
## Valor das Exportações de uva do Brasil: Janeiro de 2022 em comparação com as informações entre 2016-2021 {.tabset .tabset-fade}
...
## Volume das Exportações de uva do Brasil: Janeiro de 2022 em comparação com as informações entre 2016-2021 {.tabset .tabset-fade}
...
# 5. Principais destinos de exportação da uva do Brasil: Janeiro de 2022. {.tabset .tabset-fade}
...
# 6. Principais vias de exportação da uva do Brasil: Janeiro de 2022. {.tabset .tabset-fade}
...
# 7. Unidade da Federação da uva exportada do Brasil: Janeiro de 2022. {.tabset .tabset-fade}
...
# 8. Importação de Uva pelo Brasil: 2016-2022. {.tabset .tabset-fade}
...
# 9. Evolução da Taxa de Câmbio Esperada para Dezembro de 2022 {.tabset .tabset-fade}
