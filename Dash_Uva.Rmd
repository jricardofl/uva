...
g2 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  ...
  labs(y= "Mil Toneladas", x= "Anos", title='Evolução do Volume com uva no Vale do São Francisco: 2016-2020',
       caption = "Fonte: IBGE (2021)") +
...
g3 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  ...
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade com uva no Vale do São Francisco: 2016-2020',
       caption = "IBGE (2021)") +
...
g4 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  ...
  labs(y= "VBP (Mil R$)", x= "Anos", title='Evolução do Valor Bruto da Produção com uva no Vale do São Francisco: 2016-2020',
       caption = "IBGE (2021)") +
